 ...
 * @apiNote
 * 	1、将Advice包装成Advisor
 * 	2、借助AdvisorAdapter#getInterceptor(Advisor)，将Advisor包装成MethodInterceptor
 */
public interface AdvisorAdapterRegistry {
	 ...
	 *
	 * @apiNote 从给定的 advisor 上解析 MethodInterceptor
	 */
